  ...
  return (
    <div>
      ...
      >
        ...
        />
        <path
          d="M11 9V9.01M7 9V9.01M15 9V9.01M13 17C11.764 17 10.402 17.5 9.159 18.145C7.161 19.182 6.162 19.701 5.67 19.37C5.178 19.04 5.271 18.015 5.458 15.966L5.5 15.5"
          stroke="#F5F5F5"
          strokeWidth="2"
          stroke-linecap="round"
        />
