...
const Card1 = () => {
  return (
    <div className="bg-white   px-3 md:px-6 py-2 md:py-4 rounded-2xl rounded-br-[30px] max-w-[142.36px] md:max-w-[262px] absolute shadow-sm drop-shadow-2xl top-2/4  md:top-1/2 -left-5 md:left-0">
      ...
      {/* Card 1 */}
      <div className="mt-1 md:mt-3 flex flex-row  items-center relative    text-center justify-center max-w-max mx-auto ">
